...
public class Main {
    ...
    public static void main(String[] args) throws IllegalAccessException {
        ...
        System.out.println(ManualSerializer.toJson(university));
        System.out.println(ManualSerializer.toJson(course));
        System.out.println(ManualSerializer.toJson(student));
        System.out.println(ManualSerializer.toXml(university));
        System.out.println(ManualSerializer.toXml(course));
        System.out.println(ManualSerializer.toXml(student));
